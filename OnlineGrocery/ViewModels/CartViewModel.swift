...
class CartViewModel: ObservableObject {
    ...
    @Published var showPickerAddress = false
    @Published var showPickerPayment = false
    @Published var showPickerPromoCode = false
    
    @Published var deliveryType = 1
    @Published var paymentType = 1
    @Published var deliverObj: AddressModel?
    @Published var paymentObj: PaymentModel?
    @Published var promoObj: PromoCodeModel?
    
    @Published var deliverPriceAmount = ""
    @Published var discountAmount = ""
    @Published var userPayAmount = ""
